...
func makeUpgradeTransport(config *rest.Config, keepalive time.Duration) (proxy.UpgradeRequestRoundTripper, error) {
	klog.Info("makeUpgradeTransport")
	...
	rt := utilnet.SetOldTransportDefaults(&http.Transport{
		...
		Proxy:           func(r *http.Request) (*url.URL, error) { klog.Info("proxyUrl returned"); return proxyUrl, nil },
	...
	rt.Proxy = func(r *http.Request) (*url.URL, error) { klog.Info("proxyUrl returned"); return proxyUrl, nil }
